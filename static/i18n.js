...
const TRANSLATIONS = {
  en: {
    ...
    'rem.title': 'Remediation Cluster Report',
    'rem.subtitle': 'All corrective measures grouped by multiple criteria',
    'rem.stat_total': 'Total', 'rem.stat_completed': 'Completed',
    'rem.stat_overdue': 'Overdue', 'rem.stat_owners': 'Owners',
    'rem.tab_date': '📅 By Date', 'rem.tab_owner': '👤 By Owner',
    'rem.tab_severity': '⚡ By Severity', 'rem.tab_semantic': '🧠 Semantic (AI)',
    'rem.semantic_title': '🧠 Semantic Clustering via ChatGPT',
    'rem.semantic_desc': 'GPT-4o will analyze all corrective measure descriptions and group them into thematic clusters by semantic similarity.',
    'rem.semantic_key_ph': 'OpenAI API key (leave empty if configured on server)',
    'rem.btn_generate': '🚀 Generate Clusters',
    'rem.semantic_note': 'ℹ️ The key is not saved. If OPENAI_API_KEY is already set on the server you can leave this field empty.',
    'rem.loading': 'Loading measures...', 'rem.analyzing': 'GPT-4o is analyzing measures...',
    'rem.empty': 'No measures found.', 'rem.no_clusters': 'No clusters generated.',
    'rem.no_cluster_measures': 'No measures in clusters.', 'rem.err_load': 'Error loading data: ',
    'rem.count_one': 'measure', 'rem.count_many': 'measures',
    'rem.overdue_days': '⚠ Overdue %s d', 'rem.deadline_ok': '📅 %s',
    'rem.date_overdue_60p': '⚠️ Overdue by more than 60 days',
    'rem.date_overdue_31_60': '⚠️ Overdue 31–60 days ago',
    'rem.date_overdue_0_30': '⚠️ Overdue 0–30 days ago',
    'rem.date_next_0_30': '📅 Next 30 days', 'rem.date_next_31_60': '📅 Next 31–60 days',
    'rem.date_next_61_90': '📅 Next 61–90 days', 'rem.date_next_90p': '📅 Over 90 days',
    'rem.date_no_dl': '❓ No deadline',
    'rem.sev_1': '⚡ High (Priority 1)', 'rem.sev_2': '🔶 Relevant (Priority 2)',
    'rem.sev_3': '🔷 Medium (Priority 3)', 'rem.sev_4': '🟢 Low (Priority 4)',
  },
  ...
  it: {
    ...
    'misc.cancel': 'Annulla',
    // Remediation Cluster Report
    'rem.title': 'Report Cluster Remediation',
    'rem.subtitle': 'Tutte le misure correttive raggruppate secondo criteri multipli',
    'rem.stat_total': 'Totale', 'rem.stat_completed': 'Completate',
    'rem.stat_overdue': 'Scadute', 'rem.stat_owners': 'Responsabili',
    'rem.tab_date': '📅 Per Data', 'rem.tab_owner': '👤 Per Responsabile',
    'rem.tab_severity': '⚡ Per Severity', 'rem.tab_semantic': '🧠 Semantico (AI)',
    'rem.semantic_title': '🧠 Clustering Semantico via ChatGPT',
    'rem.semantic_desc': 'GPT-4o analizzerà le descrizioni di tutte le misure correttive e le raggrupperà in cluster tematici per somiglianza semantica.',
    'rem.semantic_key_ph': 'OpenAI API key (lascia vuoto se configurata nel server)',
    'rem.btn_generate': '🚀 Genera Cluster',
    'rem.semantic_note': 'ℹ️ La chiave non viene salvata. Se OPENAI_API_KEY è già configurata nel server puoi lasciare il campo vuoto.',
    'rem.loading': 'Caricamento misure...', 'rem.analyzing': 'GPT-4o sta analizzando le misure...',
    'rem.empty': 'Nessuna misura trovata.', 'rem.no_clusters': 'Nessun cluster generato.',
    'rem.no_cluster_measures': 'Nessuna misura nei cluster.', 'rem.err_load': 'Errore caricamento dati: ',
    'rem.count_one': 'misura', 'rem.count_many': 'misure',
    'rem.overdue_days': '⚠ Scaduto %s gg', 'rem.deadline_ok': '📅 %s',
    'rem.date_overdue_60p': '⚠️ Scaduto da oltre 60 giorni',
    'rem.date_overdue_31_60': '⚠️ Scaduto 31–60 giorni fa',
    'rem.date_overdue_0_30': '⚠️ Scaduto 0–30 giorni fa',
    'rem.date_next_0_30': '📅 Prossimi 30 giorni', 'rem.date_next_31_60': '📅 Prossimi 31–60 giorni',
    'rem.date_next_61_90': '📅 Prossimi 61–90 giorni', 'rem.date_next_90p': '📅 Oltre 90 giorni',
    'rem.date_no_dl': '❓ Senza scadenza',
    'rem.sev_1': '⚡ Alta (Priorità 1)', 'rem.sev_2': '🔶 Rilevante (Priorità 2)',
    'rem.sev_3': '🔷 Media (Priorità 3)', 'rem.sev_4': '🟢 Bassa (Priorità 4)',
  },
  ...
  el: {
    ...
    'misc.cancel': 'Ακύρωση',
    // Remediation Cluster Report
    'rem.title': 'Αναφορά Cluster Αποκατάστασης',
    'rem.subtitle': 'Όλα τα διορθωτικά μέτρα ομαδοποιημένα με πολλαπλά κριτήρια',
    'rem.stat_total': 'Σύνολο', 'rem.stat_completed': 'Ολοκληρωμένα',
    'rem.stat_overdue': 'Εκπρόθεσμα', 'rem.stat_owners': 'Υπεύθυνοι',
    'rem.tab_date': '📅 Ανά Ημερομηνία', 'rem.tab_owner': '👤 Ανά Υπεύθυνο',
    'rem.tab_severity': '⚡ Ανά Σοβαρότητα', 'rem.tab_semantic': '🧠 Σημασιολογικό (AI)',
    'rem.semantic_title': '🧠 Σημασιολογική Ομαδοποίηση μέσω ChatGPT',
    'rem.semantic_desc': 'Το GPT-4o θα αναλύσει τις περιγραφές όλων των διορθωτικών μέτρων και θα τα ομαδοποιήσει σε θεματικά clusters βάσει σημασιολογικής ομοιότητας.',
    'rem.semantic_key_ph': 'OpenAI API key (αφήστε κενό αν έχει ρυθμιστεί στον διακομιστή)',
    'rem.btn_generate': '🚀 Δημιουργία Clusters',
    'rem.semantic_note': 'ℹ️ Το κλειδί δεν αποθηκεύεται. Αν το OPENAI_API_KEY έχει ρυθμιστεί στον διακομιστή, αφήστε το πεδίο κενό.',
    'rem.loading': 'Φόρτωση μέτρων...', 'rem.analyzing': 'Το GPT-4o αναλύει τα μέτρα...',
    'rem.empty': 'Δεν βρέθηκαν μέτρα.', 'rem.no_clusters': 'Δεν δημιουργήθηκαν clusters.',
    'rem.no_cluster_measures': 'Δεν υπάρχουν μέτρα στα clusters.', 'rem.err_load': 'Σφάλμα φόρτωσης: ',
    'rem.count_one': 'μέτρο', 'rem.count_many': 'μέτρα',
    'rem.overdue_days': '⚠ Εκπρόθεσμο %s ημ.', 'rem.deadline_ok': '📅 %s',
    'rem.date_overdue_60p': '⚠️ Εκπρόθεσμο άνω των 60 ημερών',
    'rem.date_overdue_31_60': '⚠️ Εκπρόθεσμο 31–60 ημέρες',
    'rem.date_overdue_0_30': '⚠️ Εκπρόθεσμο 0–30 ημέρες',
    'rem.date_next_0_30': '📅 Επόμενες 30 ημέρες', 'rem.date_next_31_60': '📅 Επόμενες 31–60 ημέρες',
    'rem.date_next_61_90': '📅 Επόμενες 61–90 ημέρες', 'rem.date_next_90p': '📅 Άνω των 90 ημερών',
    'rem.date_no_dl': '❓ Χωρίς προθεσμία',
    'rem.sev_1': '⚡ Υψηλή (Προτεραιότητα 1)', 'rem.sev_2': '🔶 Σημαντική (Προτεραιότητα 2)',
    'rem.sev_3': '🔷 Μέτρια (Προτεραιότητα 3)', 'rem.sev_4': '🟢 Χαμηλή (Προτεραιότητα 4)',
  }
};
